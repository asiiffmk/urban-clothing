...
export default function Footer({ activeView, onContactClick }) {
        ...
        <div id="contact" className="contact-section">
          <div className="container" style={{ maxWidth: '600px', margin: '0 auto' }}>
            ...
            <div style={{
              ...
              {/* WhatsApp Button */}
              <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" className="btn btn-accent" style={{
                display: 'inline-flex',
                alignItems: 'center',
                gap: '0.5rem',
                padding: '0.65rem 1.8rem',
